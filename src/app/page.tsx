...
export default function HomePage() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100vh-var(--header-height,10rem))] text-center animate-fadeIn">
      <h1 className="text-5xl md:text-7xl font-bold mb-6 text-transparent bg-clip-text bg-gradient-to-r from-primary via-accent to-secondary">
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-12 max-w-4xl w-full">
        <Card className="bg-card/80 backdrop-blur-sm hover:shadow-xl transition-shadow">
          <CardHeader>
            <CardTitle className="flex items-center text-2xl">
              <EyeIcon className="mr-3 text-primary h-8 w-8" />
              The 20-20-20 Rule
            </CardTitle>
          </CardHeader>
          <CardContent>
            <p className="text-left text-card-foreground/90">
            ...
            <ul className="mt-4 space-y-2 text-left">
              <li className="flex items-start">
                <CheckCircle className="h-5 w-5 mr-2 mt-1 text-green-400 shrink-0" />
        ...
        <Card className="bg-card/80 backdrop-blur-sm hover:shadow-xl transition-shadow">
          <CardHeader>
            ...
            <CardDescription>Beyond eye care, Zenith Timer helps you structure any activity.</CardDescription>
          </CardHeader>
          <CardContent>
             <ul className="mt-4 space-y-2 text-left">
              <li className="flex items-start">
      ...
      <Link href="/templates">
        <Button size="lg" className="bg-primary hover:bg-primary/90 text-primary-foreground text-xl py-8 px-12 rounded-full shadow-lg hover:shadow-xl transition-all transform hover:scale-105">
